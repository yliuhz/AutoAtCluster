...
def main(args):
    ...
    with torch.no_grad():
        ...
        dataset_name = dataset_namemap[args.dataset_name]

        np.savez("outputs/GGD_{}_emb_{}.npz".format(dataset_name, seed), emb=embeds.cpu().numpy(), labels=labels[0].cpu().numpy())
...
if __name__ == '__main__':
    ...
    if seed:
        ...
        setproctitle.setproctitle("GGD-{}-{}".format(args.dataset_name, seed))
