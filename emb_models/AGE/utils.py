...
def load_data(dataset_str): # {'pubmed', 'citeseer', 'cora'}
    ...
    if dataset_str == 'wiki':
        ...
        objects = []
        for i in range(len(names)):
            with open("/data/yliumh/AutoAtClusterDatasets/AGE/data/ind.{}.{}".format(dataset_str, names[i]), 'rb') as f:
        ...
        x, y, tx, ty, allx, ally, graph = tuple(objects)
        test_idx_reorder = parse_index_file("/data/yliumh/AutoAtClusterDatasets/AGE/data/ind.{}.test.index".format(dataset_str))
        test_idx_range = np.sort(test_idx_reorder)
