...
if __name__ == "__main__":
    ...
    for seed in tqdm(seeds, total=len(seeds)):
        ...
        setproctitle.setproctitle("OursR-{}-{}".format(dataset[:2], seed))
        ...
        data = np.load("OursvsAGE/Ours/{}_{}.npz".format(args.dataset, seed))
        ...
        for sampling_edges in edges:
            ...
            os.makedirs("OursvsAGE/Cluster/Ours", exist_ok=True)
            np.savez("OursvsAGE/Cluster/Ours/lo_{}_preds_{}_{:.1f}.npz".format(args.dataset, seed, sampling_edges / m), preds=preds)
