...
if __name__ == "__main__":
    ...
    for seed in tqdm(seeds, total=len(seeds)):
        ...
        data = np.load("OursvsAGE/gs/{}_{}_{}_{:.1f}_{}_{}_{}.npz".format(dataset, seed, args.lr, args.dropout, args.epoch, args.scaler, args.mlp_layers))
        ...
        for sampling_edges in edges:
            ...
            os.makedirs("OursvsAGE/gs_preds", exist_ok=True)
            np.savez("OursvsAGE/gs_preds/{}_{}_{}_{:.1f}_{}_{}_{}_{:.1f}.npz".format(dataset, seed, args.lr, args.dropout, args.epoch, args.scaler, args.mlp_layers, sampling_edges / m), preds=preds)

        params_ = "{}_{}_{}_{:.1f}_{}_{}_{}".format(dataset, seed, args.lr, args.dropout, args.epoch, args.scaler, args.mlp_layers)
