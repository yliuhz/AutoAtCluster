...
def dbscan_cluster(adj, features, nclass, random_state=None):
    from community import community_louvain
    import networkx as nx
...
if __name__ == "__main__":
    ...
    for dataset in datasets:
        for seed in seeds:
            ...
            setproctitle.setproctitle("DBSCAN-{}-{}".format(dataset[:2], seed))

            adj, features, labels, _, _, _ = load_data(dataset)
            nclass = nclasses[dataset]

            preds = dbscan_cluster(adj, features, nclass, random_state=seed)
