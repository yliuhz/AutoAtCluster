    ...
    for model in models:
        for dataset in datasets:
            for seed in seeds:
                ...
                setproctitle.setproctitle("HDX-{}-{}-{}".format(model, dataset[:2], seed))
                ...
                preds = hdbscan_cluster(adj, features, nclass, random_state=seed, labels=labels)

                np.savez("outputs/{}_{}_{}.npz".format(model, dataset, seed), preds=preds, labels=labels)
