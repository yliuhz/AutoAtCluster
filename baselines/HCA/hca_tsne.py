...
def hca_cluster(adj, features, nclass, random_state=None, labels=None):
    from community import community_louvain
    import networkx as nx
    ...
    dist_thres = np.arange(1, max_thres+1, 1)
    ...
    for model in models:
        for dataset in datasets:
            ...
            for seed in seeds:
                ...
                setproctitle.setproctitle("HCA-{}-{}-{}".format(model, dataset[:2], seed))
                ...
                preds, dur = hca_cluster(adj, emb, nclass, random_state=seed, labels=labels)
                times.append(dur)
