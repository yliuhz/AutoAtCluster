...
if __name__ == "__main__":
    ...
    for seed in tqdm(seeds, total=len(seeds)):
        ...
        setproctitle.setproctitle("GSR-{}-{}".format(dataset[:2], args.thread))
        ...
        data = np.load("/data/liuyue/New/SBM/mySBM/gs/{}_{}_{}_{:.1f}_{}_{}_{}_{}_{}.npz".format(dataset, seed, args.lr, args.dropout, args.epoch, args.scaler, args.mlp_layers, args.pos, args.neg))
        ...
        df_data_nmi.to_csv("Ours_gs_NMI_{}_{}.csv".format(args.dataset, args.thread), index=False, mode="a+")
        df_data_ami.to_csv("Ours_gs_AMI_{}_{}.csv".format(args.dataset, args.thread), index=False, mode="a+")
        df_data_ari.to_csv("Ours_gs_ARI_{}_{}.csv".format(args.dataset, args.thread), index=False, mode="a+")
