...
if __name__ == "__main__":
    ...
    for seed in tqdm(seeds, total=len(seeds)):
        ...
        for sampling_edges in edges:
            ...
            os.makedirs("link_adj/Cluster/{}".format(args.model), exist_ok=True)
            np.savez("link_adj/Cluster/{}/lo_{}_preds_{}_{:.1f}.npz".format(args.model, args.dataset, seed, sampling_edges / m), preds=preds)
