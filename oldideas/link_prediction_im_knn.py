...
if __name__ == "__main__":
    ...
    for seed in tqdm(seeds, total=len(seeds)):
        ...
        with torch.no_grad():
            ...
            os.makedirs("link_adj_im_knn/{}".format(args.model), exist_ok=True)
            np.savez("link_adj_im_knn/{}/{}_{:.1f}_{}.npz".format(args.model, args.dataset, args.im_rate, seed), data=adj.data, row=adj.row, col=adj.col)
