...
if __name__ == "__main__":
    ...
    for seed in tqdm(seeds, total=len(seeds)):
        ...
        data = np.load("link_adj_im/{}/{}_{:.1f}_{}.npz".format(args.model, args.dataset, args.im_rate, seed))
        ...
        for sampling_edges in edges:
            ...
            os.makedirs("link_adj_im/Cluster/{}".format(args.model), exist_ok=True)
            np.savez("link_adj_im/Cluster/{}/lo_{}_preds_{:.1f}_{:d}_5.npz".format(args.model, args.dataset, args.im_rate, seed), preds=preds)
