...
if __name__ == "__main__":
    ...
    setproctitle.setproctitle("gs3-{}-{}".format(args.model, dataset[:2]))
    ...
    for seed in tqdm(seeds, total=len(seeds)):
        ...
        os.makedirs("params_O3", exist_ok=True)
        np.savez("params_O3/{}-{}.npz".format(args.model, args.dataset), pos=pos_rs[x], neg=neg_rs[y])
