...
if __name__ == "__main__":
    ...
    for seed in tqdm(seeds, total=len(seeds)):
        ...
        data = np.load("link_adj_diff_cls_knn/{}/{}_{:d}_{}.npz".format(args.model, args.dataset, args.nclass, seed))
        ...
        for sampling_edges in edges:
            ...
            os.makedirs("link_adj_diff_cls_knn/Cluster/{}".format(args.model), exist_ok=True)
            np.savez("link_adj_diff_cls_knn/Cluster/{}/lo_{}_preds_{:d}_{:d}.npz".format(args.model, args.dataset, args.nclass, seed), preds=preds)
